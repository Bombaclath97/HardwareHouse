	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link" href="componi.jsp">Componi
						il tuo PC</a></li>
				<%
					if (user != null) {
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="../vendi.jsp">Metti in vendita</a>
						<a class="dropdown-item" href="../preferiti.jsp">Lista
							preferiti</a> <a class="dropdown-item" href="../informazioni.jsp">Cambia
							informazioni</a>
